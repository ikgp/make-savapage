...
cp -R ${_PREP_HOME}/${_SAVAPAGE_EXT_NOTIFICATION_JAR} ${DIST_HOME_APP}/server/ext/lib
...
cp ${_REPO_HOME_EXT_NOTIFICATION}/*.properties.template ${DIST_HOME_APP}/server/ext
